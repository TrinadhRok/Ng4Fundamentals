...
var EventsListComponent = (function () {
    ...
    EventsListComponent.prototype.receiverEmitter = function (ss) {
        console.log('Name is' + ss);
    };
...
EventsListComponent = __decorate([
    core_1.Component({
        ...
        template: "\n    <div>\n        <h1>Upcommint Angular 2 Events</h1>\n        <hr/>\n        <div class=\"row\">\n            <div *ngFor=\"let event of events\" class=\"col-md-5\">\n                <event-thumb [event]=\"event\" #thumb (eventClick)='receiverEmitter($event);'>/</event-thumb>\n            </div>\n        </div>\n    \n    <!-- <p>{{thumb.testvar}}</p>-->\n    </div>\n    "
    }),
